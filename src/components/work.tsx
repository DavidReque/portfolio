...
const Work = () => {
  ...
  <span className='font-semibold text-blue-400'>TypeScript</span>. Mis proyectos varían desde aplicaciones web dinámicas hasta interfaces de usuario interactivas, cada una representando desafíos únicos y oportunidades de innovación.
</p>
